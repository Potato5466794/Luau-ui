...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://109724505481042"
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      Main.Size = UDim2.new(0, 114, 0, 70)
      Main.ZIndex = 1
      Main.Active = true
      Main.Draggable = true
      ...
      DropShadow.Image = "rbxassetid://91957628690452" --背景
    ...
    Tween(Main, {0.3, 'Sine', 'InOut'}, {
        Size = UDim2.new(0, 114, 0, (toggled and 70 or 0))  -- 20%大小
    })
end
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://113478493756976"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://113478493756976" or "rbxassetid://113478493756976" --开关的图
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://115383320677494" or icon and "rbxassetid://"..icon
...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionOpen.Image = "rbxassetid://109724505481042"
          ...
          SectionOpened.Image = "rbxassetid://108223828565891"
